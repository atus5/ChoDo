		...
		<nav class="navbar navbar-expand">
			...
			<div class="user-box dropdown">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
					...
					<img src="https://voz.vn/attachments/542754057_1467285577853420_8471185407916019492_n-jpg.3225827/" class="user-img" alt="user avatar" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
					<div class="user-info ps-3">
					<p class="user-name mb-0">Khô gà Chộ Đó</p>
				...
				<ul class="dropdown-menu dropdown-menu-end">
					...
					<li><a class="dropdown-item" @click="dangXuat()"><i
...
export default {
	methods: {
		dangXuat() {
			// Xác định loại user (admin hoặc client)
			...
			if (keyAdmin) {
				...
				axios.get('http://127.0.0.1:8000/api/client/dang-xuat', {
					headers: {
						Authorization: 'Bearer ' + keyClient
					}
				})
					.then((res) => {
				...
				// Không có token nào, redirect về trang chủ
				this.$router.push('/');
			}
		}
	},
